'''
This module is used to gather information about the environment and assets (the model you try to execute).
Noteable methods:
    system_monitor: returns information about the system, such as memory, cpu, and processes
    gather_provenance_info: returns information about the environment and assets (the model you try to execute)
'''
