...
singularity exec --nv --bind /mnt/qb/goswami/data/era5,/mnt/qb/work2/goswami0/gkd965 /mnt/qb/work2/goswami0/gkd965/sfno_packages8.sif /opt/conda/envs/model/bin/python /home/goswami/gkd965/MasterML/main.py python main.py --model sfno --model-version latest --train --validation-interval 10 --validation-epochs 5 --training-workers 6 --batch-size 1 --wandb
