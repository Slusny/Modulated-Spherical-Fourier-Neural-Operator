...
#SBATCH --error=/home/goswami/gkd965/jobs/job.1filmCLS.HSd.ddp.%J.err
# write the error output to job.*jobID*.err

#SBATCH --output=/home/goswami/gkd965/jobs/job.1filmCLS.HSd.ddp.%J.out
