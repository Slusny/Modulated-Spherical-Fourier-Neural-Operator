...
#SBATCH --job-name=transopt #21gcn
...
#SBATCH --error=/home/goswami/gkd965/jobs/job.11trans100b12l.%J.err
# write the error output to job.*jobID*.err

#SBATCH --output=/home/goswami/gkd965/jobs/job.11trans100b12l.%J.out
...
singularity exec --nv --bind /mnt/qb/goswami/data/era5,/mnt/qb/work2/goswami0/gkd965 /mnt/qb/work2/goswami0/gkd965/sfno_packages8.sif /opt/conda/envs/model/bin/python /home/goswami/gkd965/MasterML/main.py --model sfno --model-version film --train --validation-interval 1 --validation-epochs 5 --training-workers 6 --batch-size 1 --scheduler CosineAnnealingLR --scheduler-horizon 2000 --learning-rate 0.001 --multi-step-training 1 --training-step-skip 1 --film-gen transformer --accumulation-steps 100 --wandb --save-checkpoint-interval 3 --advanced-logging --film-layers 12 --enable-amp --checkpointing-block --checkpointing-encoder
