...
#SBATCH --error=/home/goswami/gkd965/jobs/job.1filmCLS.resume.%J.err
# write the error output to job.*jobID*.err

#SBATCH --output=/home/goswami/gkd965/jobs/job.1filmCLS.resume.%J.out
...
singularity exec --nv --bind /mnt/qb/goswami/data/era5,/mnt/qb/work2/goswami0/gkd965,/home/scratch_local /mnt/qb/work2/goswami0/gkd965/sfno_packages8.sif /opt/conda/envs/model/bin/python /home/goswami/gkd965/MasterML/main.py --model sfno --train --resume-checkpoint /mnt/qb/work2/goswami0/gkd965/checkpoints/peachy-leaf-68-sID{340892}/checkpoint_sfno_film_mae_iter=24099_epoch=0.pkl --accumulation-steps 2 --jobID $SLURM_JOB_ID 
