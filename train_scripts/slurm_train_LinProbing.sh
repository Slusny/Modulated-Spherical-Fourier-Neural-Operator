...
singularity exec --nv --bind /mnt/qb/goswami/data/era5,/mnt/qb/work2/goswami0/gkd965,/home/scratch_local /mnt/qb/work2/goswami0/gkd965/sfno_packages8.sif /opt/conda/envs/model/bin/python /home/goswami/gkd965/MasterML/main.py --model mae --model-version lin-probe --film-gen mae --train --cls /mnt/qb/work2/goswami0/gkd965/checkpoints/mae/glorious-deluge-23/checkpoint_mae_latest_None_iter=0_epoch=8-cls_decoder-1979-2019.npy --oni-path /mnt/qb/work2/goswami0/gkd965/Assets/mae/oni.npy --advanced-logging --validation-interval 100 --validation-epochs 2 --save-checkpoint-interval 100 --training-workers 7  --learning-rate 0.00005 --scheduler CosineAnnealingLR --scheduler-horizon 270275 --loss-fn MSE --trainingset-start-year 1979 --trainingset-end-year 2016 --validationset-start-year 2016 --validationset-end-year 2018 --training-epochs 5 --batch-size 1000 --notes 'lin probing of glorious-deluge-23 decoder LBFGS' -optimizer LBFGS --wandb --jobID $SLURM_JOB_ID 
