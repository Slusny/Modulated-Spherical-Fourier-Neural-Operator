...
singularity exec --nv --bind /mnt/qb/goswami/data/era5,/mnt/qb/work2/goswami0/gkd965 /mnt/qb/work2/goswami0/gkd965/sfno_packages8.sif /opt/conda/envs/model/bin/python /home/goswami/gkd965/MasterML/main.py --model sfno --model-version film --train --validation-interval 3 --validation-epochs 5 --training-workers 6 --batch-size 1 --learning-rate 0.0005 --multi-step-training 1 --training-step-skip 0 --film-gen gcn --film-layers 12 --wandb --save-checkpoint-interval 3 --advanced-logging --accumulation-steps 100 --loss-fn CosineMSE 
