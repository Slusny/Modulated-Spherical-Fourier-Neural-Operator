...
# ssh
python /home/goswami/gkd965/MasterML/main.py --train --model sfno --model-version film --film-gen gcn --training-workers 6 --multi-step-training 3 --advanced-logging --model-depth 14 --film-layers 2 --learning-rate 0.0005 --discount-factor 0.85 --ddp --scheduler CosineAnnealingLR --scheduler-horizon 108110 --loss-fn L2Sphere_noSine --validation-interval 6 --validation-epochs 2 --multi-step-validation 2 --validation-step-skip 15 --save-checkpoint-interval 20 --training-epochs 2 --accumulation-steps 16 --enable-amp --checkpointing-decoder --retrain-film --wandb --wandb-project gcn --jobID 21191 > /home/goswami/gkd965/jobs/job.gcn.retrain.21191.out 2> /home/goswami/gkd965/jobs/job.gcn.resume.21191.out
