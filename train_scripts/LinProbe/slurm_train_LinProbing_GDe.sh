...
#SBATCH --error=/home/goswami/gkd965/jobs/job.linprob.GDe.%J.out
# write the error output to job.*jobID*.err

#SBATCH --output=/home/goswami/gkd965/jobs/job.linprob.GDe.%J.out
...
singularity exec --nv --bind /mnt/qb/goswami/data/era5,/mnt/qb/work2/goswami0/gkd965,/home/scratch_local /mnt/qb/work2/goswami0/gkd965/sfno_packages8.sif /opt/conda/envs/model/bin/python /home/goswami/gkd965/MasterML/main.py --model mae --model-version lin-probe --film-gen mae --train --cls /mnt/qb/work2/goswami0/gkd965/checkpoints/mae/glorious-deluge-23/checkpoint_mae_latest_None_iter=0_epoch=8-cls_encoder-1979-2019.npy --oni-path /mnt/qb/work2/goswami0/gkd965/Assets/mae/oni.npy --advanced-logging --validation-interval -1 --validation-epochs 10 --save-checkpoint-interval -1 --training-workers 7  --learning-rate 0.001 --scheduler CosineAnnealingLR --scheduler-horizon 6486600 --loss-fn L1 --trainingset-start-year 1979 --trainingset-end-year 2016 --validationset-start-year 2016 --validationset-end-year 2018 --training-epochs 120 --batch-size 54055 --batch-size-validation 50 --notes 'lin probing of glorious-deluge-23 encoder' --wandb --jobID $SLURM_JOB_ID 
