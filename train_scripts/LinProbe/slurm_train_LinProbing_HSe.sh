...
#SBATCH --error=/home/goswami/gkd965/jobs/job.linprob.HSe.%J.out
# write the error output to job.*jobID*.err

#SBATCH --output=/home/goswami/gkd965/jobs/job.linprob.HSe.%J.out
