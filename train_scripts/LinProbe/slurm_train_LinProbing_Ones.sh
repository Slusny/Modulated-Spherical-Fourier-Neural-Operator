...
#SBATCH --error=/home/goswami/gkd965/jobs/job.linprob.Ones.%J.out
# write the error output to job.*jobID*.err

#SBATCH --output=/home/goswami/gkd965/jobs/job.linprob.Ones.%J.out
...
singularity exec --nv --bind /mnt/qb/goswami/data/era5,/mnt/qb/work2/goswami0/gkd965,/home/scratch_local /mnt/qb/work2/goswami0/gkd965/sfno_packages8.sif /opt/conda/envs/model/bin/python /home/goswami/gkd965/MasterML/main.py --model mae --model-version lin-probe --film-gen mae --train --cls /mnt/qb/work2/goswami0/gkd965/Assets/mae/ones_cls.npy --oni-path /mnt/qb/work2/goswami0/gkd965/Assets/mae/oni.npy --advanced-logging --validation-interval -1 --validation-epochs 10 --save-checkpoint-interval -1 --training-workers 7  --learning-rate 0.001 --scheduler CosineAnnealingLR --scheduler-horizon 3243300 --loss-fn L1 --trainingset-start-year 1979 --trainingset-end-year 2016 --validationset-start-year 2016 --validationset-end-year 2018 --training-epochs 60 --batch-size 54055 --batch-size-validation 50 --notes 'lin probing of Ones' --wandb --jobID $SLURM_JOB_ID 
