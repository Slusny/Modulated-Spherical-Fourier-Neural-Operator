...
#SBATCH --partition=cpu-short#cpu-short #gpu-v100  #gpu-2080ti #cpu-long
...
singularity exec --nv --bind /mnt/qb/goswami/data/era5,/mnt/qb/work2/goswami0/gkd965 /mnt/qb/work2/goswami0/gkd965/setup.sif download_wb2.sh #parallel_clima_byhand.py 2 #chunky_climatology.py 2
